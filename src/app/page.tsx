...
>
  About Me
        ...
        <p className="max-w-2xl text-center mt-2 mb-48">I am a creative developer with experience in building beautiful and performant web applications using modern technologies.</p>
        <div className="mb-6">
